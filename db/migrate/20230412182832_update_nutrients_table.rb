class UpdateNutrientsTable < ActiveRecord::Migration[7.0]
  ...
  def up
    ...
    rename_column :nutrients, :unit, :unit_code if column_exists? :nutrients, :unit
    change_column :nutrients, :unit_code, :string, limit: 8, null:false
    ...
    add_column :nutrients, :use_me_id, :integer, null: true unless column_exists? :nutrients, :use_me_id
  ...
  def down
    ...
    rename_column :nutrients, :unit_code, :unit if column_exists? :nutrients, :unit_code
    change_column :nutrients, :unit, :string
    ...
    remove_column :nutrients, :use_me_id if column_exists? :nutrients, :use_me_id
