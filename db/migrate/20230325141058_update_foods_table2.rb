class UpdateFoodsTable2 < ActiveRecord::Migration[7.0]
  ...
  def up
    ...
    add_column :foods, :samples_json, :text, null: false, default: '' unless column_exists? :foods, :samples_json
    ...
    add_index :foods, :name, unique: true, name: 'ix_foods_on_name' unless index_exists?(:foods, :name, name: 'ix_foods_on_name')
  end
